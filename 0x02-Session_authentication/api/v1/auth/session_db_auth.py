#!/usr/bin/env python3
"""Module providing Session in Database authentication."""
...
class SessionDBAuth(SessionExpAuth):
    ...
    Parameters:
        SessionExpAuth (Type): Inherits from SessionExpAuth class.
    """
    ...
    def user_id_for_session_id(self, session_id=None):
        """Retrieve user ID for the given session ID from the database.
